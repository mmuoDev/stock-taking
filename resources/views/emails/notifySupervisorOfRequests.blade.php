                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">Notification from the&nbsp;</span></span></p>
                                                                                </div>
                                                                            </div></td>
                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <h2 >Hello, you have got a new notification!</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p >
                                                                            A request to alter the stock of <b>[{{$content['item']}}]</b> has been made.
                                                                            Please <a href="{{url('/requests/request/'.$content['request_uri'])}}" target="_blank">click here</a> to approve/decline request. <br>
                                                                            <br>
                                                                            <br>
