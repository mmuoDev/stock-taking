                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">Welcome to the&nbsp;</span></span></p>
                                                                                </div>
                                                                            </div></td>
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;'><span class="font">[Stock-Taking Software]</span> </p>
                                                                                </div>
                                                                            </div></td>
                                                                    </tr>
                                                                    </tbody>
                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <h2 >Hello {{$content['name']}}, you have got a new notification!</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p >
                                                                            A new account has been created for you!. You are currently limited to {{$content['item_limit']}} items,
                                                                            {{$content['request_limit']}} requests, {{$content['category_limit']}} categories and {{$content['user_limit']}}
                                                                            users. Feel free to contact us on +2348063321043 to upgrade your plan.
                                                                            <br><br>
                                                                            Please <a href="{{url('/')}}" target="_blank">click here</a> to login. <br>
                                                                            <br>
                                                                            <br>
                                                                            ...
                                                                            Cheers,
                                                                            <br>
                                                                            <span style='color:#222222;'>The Support Team</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                        ...
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                        <span style='font-weight:bold;'>Techie Solutions</span>
                                                                                        <br>
                                                                                        Lagos, Nigeria
                                                                                        <br>
                                                                                ...
                                                                                <tr>
                                                                                    <td valign='top' width='52'>
                                                                                        <div class="contentEditableContainer contentFacebookEditable">
                                                                                            <div class="contentEditable">
                                                                                                <a target='_blank' href="#"><img src="{{asset('/img/facebook.png')}}" width='52' height='53' alt='facebook icon' data-default="placeholder" data-max-width="52" data-customIcon="true"></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td valign='top' width='52'>
                                                                                        <div class="contentEditableContainer contentTwitterEditable">
                                                                                            <div class="contentEditable">
                                                                                                <a target='_blank' href="#"><img src="{{asset('/img/twitter.png')}}" width='52' height='53' alt='twitter icon' data-default="placeholder" data-max-width="52" data-customIcon="true"></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
