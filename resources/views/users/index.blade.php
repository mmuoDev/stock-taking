                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(empty($photo))
                                                    N/A
                                                @else
                                                    <img src="{{asset('uploads/users/'.$photo)}}" width="50" height="50">
                                                @endif
                                            </td>
                                            <td>{{$user->role}}</td>
                                            <td>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered" id="items">
                                    ...
                                    <tr style="background-color: #f9f9f9;">
                                        ...
                                        <th width="25%" class="text-left">Password</th>
                                    ...
                                    <tr id="item-row-{{ $item_row }}">
                                        ...
                                        <td>
                                            <input  class="form-control" name="item[{{ $item_row }}][file]" onkeyup="" type="file" id="item-file-{{ $item_row }}">
                                        </td>
    ...
    <script>
        //$( function() {
            ...
            function addItem() {
                ...
                html += '  </td>';
                html += '  <td>';
                html += '      <input onkeyup="" class="form-control" onclick="" required="required" name="item[' + item_row + '][file]" type="file" id="item-file-' + item_row + '">';
                html += '  </td>';
